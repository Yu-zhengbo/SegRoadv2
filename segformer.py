...
class SegFormer_Segmentation(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"        : "logs/last_epoch_weights_b1_stripe_conv_new_dcn2x_seg_finetune_bs4.pth",
        #----------------------------------------#
        #   所需要区分的类的个数+1
        #----------------------------------------#
        "num_classes"       : 2,
    ...
    def detect_image(self, image, count=False, name_classes=None):
        ...
        with torch.no_grad():
            ...
            pred_full[pred_full > 0.45] = 1
            pred_full[pred_full < 0.45] = 0
    ...
    def get_miou_png(self, image):
        ...
        with torch.no_grad():
            ...
            #   图片传入网络进行预测
            # ---------------------------------------------------#
            pr, out_connect, out_connect_d1,pr1 = self.net(images)
            # ---------------------------------------------------#
            ...
            pred_full[pred_full >= 0.55] = 1
            pred_full[pred_full < 0.55] = 0
            pr = pred_full + pred_connect_d1 + pred_connect
