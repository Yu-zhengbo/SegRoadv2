...
if os.path.exists('./model_data/train_val'):
    ...
    train_lines = read_txt('./model_data/train_val/train_mass.txt') + read_txt('./model_data/train_val/val_mass.txt')
    val_lines = read_txt('./model_data/train_val/test_mass.txt')
